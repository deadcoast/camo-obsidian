# CAMO Complete Design Specification
...
1. [OVERVIEW](./1_OVERVIEW.md) - OVERVIEW OF FULL CAMO SYTEMS
2. [ALLABOUT-camoMetaData](./2_ALLABOUT-camoMetaData.md) - "GettingStarted" style document on `camoMetaData`
3. [camoMetaData](./4_camoMetaData.md) - Dedidated `camoMetaData` syntax document
4. [nestingRules](./5_nestingRules.md) - `nestingRules` for the `camoMetaData` syntax
5. [systemArchitecture](./7_systemArchitecture.md) - Techtical implementation breakdown of the sourcecode
6. [userExperience](./6_userExperience.md) - Enhancements for user QOL
